...
function sonEstrictamenteIguales(x, y) {
  // Equality estricta: usá sólo === (no uses ==).
...
function puedePasarAlEvento(edad, tieneEntrada, esVIP) {
  // Puede pasar si es VIP directamente, O si siendo mayor de edad tiene su entrada.
